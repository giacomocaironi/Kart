...
const READTHEDOCS_DATA = new Object();
READTHEDOCS_DATA.project = "kart-ssg"
READTHEDOCS_DATA.version = "latest"
READTHEDOCS_DATA.proxied_api_host = "https://readthedocs.org"

window.addEventListener("DOMContentLoaded", () => {
    // only add event listeners if READTHEDOCS_DATA global
    // variable is found.
    if (window.hasOwnProperty("READTHEDOCS_DATA") || true) {
        ...
        // close the search modal if the user pressed Escape button
